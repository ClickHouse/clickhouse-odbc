...
TEST_F(TypeInfoTest, SQLGetTypeInfoResultSet)
{
    ...
    //                   ODBC                          pre/suffix create  unsi-  min/max                 date radix
    //   type name       data type           size      params     params  gned   scale    sql data type  sub  radix
        {"Nothing",     {SQL_TYPE_NULL,      1,        na,  na,   na,     true,  na, na,  SQL_TYPE_NULL, na,  na,  }},
        {"Int8",        {SQL_TINYINT,        4,        na,  na,   na,     false, na, na,  SQL_TINYINT,   na,  na,  }},
        {"UInt8",       {SQL_TINYINT,        3,        na,  na,   na,     true,  na, na,  SQL_TINYINT,   na,  na,  }},
        {"Int16",       {SQL_SMALLINT,       6,        na,  na,   na,     false, na, na,  SQL_SMALLINT,  na,  na,  }},
        {"UInt16",      {SQL_SMALLINT,       5,        na,  na,   na,     true,  na, na,  SQL_SMALLINT,  na,  na,  }},
        {"Int32",       {SQL_INTEGER,        11,       na,  na,   na,     false, na, na,  SQL_INTEGER,   na,  na,  }},
        {"UInt32",      {SQL_BIGINT,         10,       na,  na,   na,     true,  na, na,  SQL_BIGINT,    na,  na,  }},
        {"Int64",       {SQL_BIGINT,         20,       na,  na,   na,     false, na, na,  SQL_BIGINT,    na,  na,  }},
        {"UInt64",      {SQL_BIGINT,         20,       na,  na,   na,     true,  na, na,  SQL_BIGINT,    na,  na,  }},
        {"Float32",     {SQL_REAL,           7,        na,  na,   na,     false, na, na,  SQL_REAL,      na,  2,   }},
        {"Float64",     {SQL_DOUBLE,         15,       na,  na,   na,     false, na, na,  SQL_DOUBLE,    na,  2,   }},
        {"Decimal",     {SQL_DECIMAL,        41,       na,  na,   na,     false, 1,  76,  SQL_DECIMAL,   na,  na,  }},
        {"String",      {SQL_VARCHAR,        max_size, "'", "'",  na,     true,  na, na,  SQL_VARCHAR,   na,  na,  }},
        {"FixedString", {SQL_VARCHAR,        max_size, "'", "'",  na,     true,  na, na,  SQL_VARCHAR,   na,  na,  }},
        {"Date",        {SQL_TYPE_DATE,      10,       na,  na,   na,     true,  na, na,  SQL_DATE,      1,   na,  }},
        {"DateTime",    {SQL_TYPE_TIMESTAMP, 19,       na,  na,   na,     true,  na, na,  SQL_DATE,      3,   na,  }},
        {"DateTime64",  {SQL_TYPE_TIMESTAMP, 29,       na,  na,   na,     true,  na, na,  SQL_DATE,      3,   na,  }},
        {"UUID",        {SQL_GUID,           35,       na,  na,   na,     false, na, na,  SQL_GUID,      na,  na,  }},
        {"Array",       {SQL_VARCHAR,        max_size, na,  na,   na,     true,  na, na,  SQL_VARCHAR,   na,  na,  }},
    };
    // clang-format on
    ...
    while (reader.fetch())
    {
        ...
        EXPECT_EQ(reader.getData<std::string>("TYPE_NAME"), type);
        ...
        EXPECT_EQ(reader.getData<SQLINTEGER>("AUTO_UNIQUE_VALUE"), SQL_FALSE);
        EXPECT_EQ(reader.getData<std::string>("TYPE_NAME"), type);
