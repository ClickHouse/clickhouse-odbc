           ...
           PTR out_value, SQLSMALLINT out_value_max_length, SQLSMALLINT * out_value_length)
{
    ...
    return doWith<Connection>(connection_handle, [&](Connection & connection)
    {
        ...
        switch (info_type)
        {
            CASE_STRING(SQL_DRIVER_VER, TEXT("1.0"))
            CASE_STRING(SQL_DRIVER_ODBC_VER, TEXT("03.80"))
            CASE_STRING(SQL_DM_VER, TEXT("03.80.0000.0000"))
            CASE_STRING(SQL_DRIVER_NAME, TEXT("ClickHouse ODBC"))
            CASE_STRING(SQL_DBMS_NAME, TEXT("ClickHouse"))
            CASE_STRING(SQL_DBMS_VER, TEXT("01.00.0000"))
            CASE_STRING(SQL_SERVER_NAME, connection.host)
            CASE_STRING(SQL_DATA_SOURCE_NAME, TEXT("ClickHouse"))
            CASE_STRING(SQL_CATALOG_TERM, TEXT("catalog"))
            CASE_STRING(SQL_COLLATION_SEQ, TEXT("UTF-8"))
            CASE_STRING(SQL_DATABASE_NAME, connection.database)
            CASE_STRING(SQL_KEYWORDS, TEXT(""))
            CASE_STRING(SQL_PROCEDURE_TERM, TEXT("stored procedure"))
            CASE_STRING(SQL_CATALOG_NAME_SEPARATOR, TEXT("."))
            CASE_STRING(SQL_IDENTIFIER_QUOTE_CHAR, TEXT("`"))
            CASE_STRING(SQL_SEARCH_PATTERN_ESCAPE, TEXT("\\"))
            CASE_STRING(SQL_SCHEMA_TERM, TEXT("schema"))
            CASE_STRING(SQL_TABLE_TERM, TEXT("table"))
            CASE_STRING(SQL_SPECIAL_CHARACTERS, TEXT(""))
            CASE_STRING(SQL_USER_NAME, connection.user)
            CASE_STRING(SQL_XOPEN_CLI_YEAR, TEXT("2015"))
            ...
            CASE_STRING(SQL_COLUMN_ALIAS, TEXT("Y"))
            ...
            CASE_STRING(SQL_DESCRIBE_PARAMETER, TEXT("N"))
