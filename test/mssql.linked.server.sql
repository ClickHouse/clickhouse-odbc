...
exec('CREATE TABLE IF NOT EXISTS default.fixedstring ( xx FixedString(100)) ENGINE = Memory;') at [clickhouse_link_test];
exec(N'INSERT INTO default.fixedstring VALUES (''a''), (''abcdefg''), (''абвгдеёжзийклмнопрстуфх'');') at [clickhouse_link_test];
--exec('INSERT INTO test.fixedstring VALUES (''a''),(''abcdefg'');') at [clickhouse_link_test];
exec('select xx as x from default.fixedstring;') at [clickhouse_link_test];
exec('DROP TABLE default.fixedstring;') at [clickhouse_link_test];
