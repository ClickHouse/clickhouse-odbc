...
| SqlCompatibilitySetting |                                                          `off`                                                           | Enables query settings such as `cast_keep_nullable` and `prefer_column_name_to_alias` that make ClickHouse behave more like a traditional relational database.                          |
